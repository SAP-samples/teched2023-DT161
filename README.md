...
This repository contains the material for the SAP TechEd 2022 session called “Simplified Selective Data Transition (DT161)” 
...
You can logon to SAP Business Transformation Center using the following URL: https://dt161-vygek9xc.eu10.alm.cloud.sap 
...
Step 1.1. – Download the SAP Readiness Check UDP example file <here (link to Matthias Sch. RC file> 
...
Start the name of the analysis file with your group id followed by dash “###-“ and optionally provide a short description in the field “Notes” 
